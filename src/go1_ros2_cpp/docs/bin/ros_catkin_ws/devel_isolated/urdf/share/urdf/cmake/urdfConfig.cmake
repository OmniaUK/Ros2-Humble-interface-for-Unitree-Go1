...
if("TRUE" STREQUAL "TRUE")
  set(urdf_SOURCE_PREFIX /home/pi/ros_catkin_ws/src/david/urdf)
  set(urdf_DEVEL_PREFIX /home/pi/ros_catkin_ws/devel_isolated/urdf)
...
if(NOT "/home/pi/ros_catkin_ws/src/david/urdf/include;/home/pi/ros_catkin_ws/devel_isolated/urdf/include;/opt/ros/melodic/lib/urdfdom_headers/cmake/../../../include;/opt/ros/melodic/include;/usr/include " STREQUAL " ")
  set(urdf_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/ros_catkin_ws/src/david/urdf/include;/home/pi/ros_catkin_ws/devel_isolated/urdf/include;/opt/ros/melodic/lib/urdfdom_headers/cmake/../../../include;/opt/ros/melodic/include;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'urdf' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/ros_catkin_ws/src/david/urdf/${idir}'.  ${_report}")
    endif()
    _list_append_unique(urdf_INCLUDE_DIRS ${include})
  endforeach()
endif()

set(libraries "urdf;/opt/ros/melodic/lib/liburdfdom_sensor.so;/opt/ros/melodic/lib/liburdfdom_model_state.so;/opt/ros/melodic/lib/liburdfdom_model.so;/opt/ros/melodic/lib/liburdfdom_world.so;/usr/lib/aarch64-linux-gnu/libconsole_bridge.so.0.4;/usr/lib/aarch64-linux-gnu/libboost_thread.so;-pthread;/usr/lib/aarch64-linux-gnu/libboost_chrono.so;/usr/lib/aarch64-linux-gnu/libboost_system.so;/usr/lib/aarch64-linux-gnu/libboost_date_time.so;/usr/lib/aarch64-linux-gnu/libboost_atomic.so;/usr/lib/aarch64-linux-gnu/libtinyxml.so;/usr/lib/aarch64-linux-gnu/libtinyxml2.so")
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/ros_catkin_ws/devel_isolated/urdf/lib;/opt/ros/melodic/lib)
