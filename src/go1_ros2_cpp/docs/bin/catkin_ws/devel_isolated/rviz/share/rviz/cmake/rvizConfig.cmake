...
if("TRUE" STREQUAL "TRUE")
  set(rviz_SOURCE_PREFIX /home/pi/catkin_ws/src/rviz)
  set(rviz_DEVEL_PREFIX /home/pi/catkin_ws/devel_isolated/rviz)
  set(rviz_INSTALL_PREFIX "")
  set(rviz_PREFIX ${rviz_DEVEL_PREFIX})
else()
  set(rviz_SOURCE_PREFIX "")
  set(rviz_DEVEL_PREFIX "")
  set(rviz_INSTALL_PREFIX /home/pi/catkin_ws/install_isolated)
...
if(NOT "/home/pi/catkin_ws/src/rviz/src;/home/pi/catkin_ws/devel_isolated/rviz/include;/usr/local/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include " STREQUAL " ")
  set(rviz_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws/src/rviz/src;/home/pi/catkin_ws/devel_isolated/rviz/include;/usr/local/include/eigen3;/usr/include/OGRE/Overlay;/usr/include/OGRE;/usr/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'rviz' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws/src/rviz/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws/devel_isolated/rviz/lib;/home/pi/catkin_ws/devel_isolated/go1_description/lib;/opt/ros/melodic/lib)
...
set(depends "geometry_msgs;image_transport;interactive_markers;laser_geometry;map_msgs;message_filters;nav_msgs;pluginlib;resource_retriever;roscpp;roslib;sensor_msgs;std_msgs;std_srvs;tf;urdf;visualization_msgs")
